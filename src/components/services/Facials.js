...
const facials = [
  {
    row: [
      ...
      },
      {
        ...
        desc: "Purify your neck, shoulders and back, with a custom organic blend made moments before your treatment.",
        sm: 12,
        xl: 4,
      },
      {
        ...
        price: "45 Minutes: $147.00",
        desc: "Lemons and poppy seed facial wrinkles and fine line reducer. It exfoliates and polishes leaving skin radiant! With all organic products featuring lemon, poppy seeds ,coconut oil rosemary nutmeg and vitamin E and B-5 almond oil , pecan shells, grape fruit and clove.",
        sm: 12,
        xl: 4,
      },
    ],
  },
  {
    row: [
      ...
      },
      {
        ...
        desc: "Minimize pores and wipes out dead surface from your face. Rare Amazonian white clay, Herbal Moisturizer, cinnamon Bark, Ginger Root, Apricot Kernel Oil, Vitamin E, Avocado Oil Sweet Almond Oil.",
        sm: 12,
        xl: 4,
      },
    ],
    ...
    row: [
      {
        ...
        desc: "This mask works against Acne and eczema. Perfect for anti-aging absorbs free Radicals.",
        sm: 12,
        xl: 4,
      },
      {
        ...
        desc: "This tailor-made treatment utilizes actives that address his skin. The face is deeply cleansed, moisturized, and soothed to reduce sensitivity commonly associated with daily shaving. An energizing facial mask applied during a scalp massage is a must to leave him feeling revived and relaxed, so that challenges of the day can be boldly met and conquered with confidence.",
        sm: 12,
        xl: 4,
      },
      {
    ...
    row: [
      {
        ...
        price: "45 Minutes: $147.00",
        desc: "Its fights free radicals, rejuvenates your face while recharging your cells. It keeps you moisturized all day helping you pull out hard to get white heads. Charcoal, volcanic ash, Acai and goji berry, green tea and fig antioxidants.",
        sm: 12,
        xl: 4,
      },
      {
        ...
        price: "$147.00",
        desc: "This facial purifies and cleanses the skin of city dwellers by providing a deep cleanse with our Cleansing Foaming Cream that helps tired, polluted dull skin. 1st with our Multi- Resurfacing Exfoliant that reduces the depth of wrinkles and restores radiance. 2nd we apply the Pure Pore Heating Mask that completely depollutes, sanitizes, and leaves pores unclogged. Lastly we moisturize with City Life Face &amp; Eye Contour Sorbet Cream that protects skin from pollutants in the air.",
        sm: 12,
        xl: 4,
      },
      {
  ...
  },
  {
    row: [
      ...
      },
      {
        ...
        price: "$167.00",
        desc: "Using our Phytomer products that help replenish minerals that you lose from stress or other contraindications. This facial helps with discoloration of the skin, ingrown hair, and stretch marks.",
        sm: 12,
        xl: 4,
      },
      {
    ...
    row: [
      {
        ...
        price: "Add onto any facial for $92.00",
        desc: "A non-invasive procedure that uses tiny crystals or other exfoliating surfaces to help remove the superficial layer of dead skin cells",
        sm: 12,
        xl: 4,
      },
      {
        ...
        desc: "Self-Heating Back Detox that pulls toxins out, relieves tension, water retention, and relaxes deeply.",
        sm: 12,
        xl: 4,
      },
    ],
