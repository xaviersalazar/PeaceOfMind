...
const addons = [
  {
    row: [
      ...
      },
      {
        ...
        desc: "These natural oils are a purifying dose of detoxification; they also provide illuminating moisture reintroducing the glow to overly dry skin.",
        sm: 12,
        xl: 4,
      },
      {
    ...
    row: [
      {
        ...
        desc: "Adding a dry brush to your massage helps by exfoliating & stimulating the lymphatic system and circulation starts at the feet and works it way up including under arms. Proven to help with cellulite, removes dead skin cells, and aids in decreasing bloating. Great with aroma therapy to accelerate blood flow.",
        sm: 12,
        xl: 4,
      },
      {
        ...
        desc: "Experience the Flame an irresistible Hot Oil Massage. 100% Natural Multi-Sensory Experience. Lavish blend of exotic palm kernel oil, soy oil, Shea butter, jojoba oil, Vitamin E, organic coconut oil, and essential oils. It leaves the skin silky smooth and irresistibly scented.",
        sm: 12,
        xl: 4,
      },
      {
        ...
        desc: "This treatment covers the entire torso for total body warmth sending you in to a new world of Bliss and Deep Relaxation. Lavender, valerian root, white willow, chamomile, rosemary, peppermint, spearmint, hops, yellow dock, lemongrass, cinnamon, yarrow, premium flax seeds. Ideal for clients that suffer from arthritis, back pain, stress relief and many other common ailments.",
        sm: 12,
        xl: 4,
      },
    ],
  },
  {
    row: [
      ...
      },
      {
        ...
        desc: "Kills Bacteria Pathogens, Reduces Inflammation, Supports the Immune System, Eases Respiratory Discomfort, Lifts the Spirit, Relaxes Muscles, Curbs Digestive Upset, Relieves Body & Joint Pain, Balances Energy, Restores Calmness, Increases Concentration",
        sm: 12,
        xl: 4,
      },
    ],
    ...
    row: [
      {
        ...
        price: "$57.00",
        desc: "CBD oil reduces inflammation, is a potent pain reliever. It alleviates stress and anxiety, may help with skin cancer and other skin stresses. Also helps clear toxins' ultimate skin protector and moisturizer.",
        sm: 12,
        xl: 4,
      },
      {
      ...
      },
      {
        ...
        price: "$47.00",
        desc: "Temporarily relieves arthritic pain, muscle and joint pain, and stiffness. Increases blood circulation, speed healing, and diminishes bruising. Also is a natural solution to help achieve clear and healthy skin by treating existing blemishes, minimizing breakouts, and recapturing your radiant glow. It is the most effective and affordable technology for achieving healthy and youthful skin.",
        sm: 12,
        xl: 4,
      },
    ],
    ...
    row: [
      {
        ...
        title: "Lava Shells",
        price: "$47.00",
        desc: "When filled with the patented self-heating technology of Lava Gel, Lava Shells heat for up to 45-minutes, depending on the method of application, giving you the same heat as a full hot stone massage with just two shells – no electricity of equipment needed",
        sm: 12,
        xl: 4,
      },
      {
