  ...
  <div>
    <ColoredCol xs={12}>
      ...
      <p className="text-center px-5 light-text">
        ...
        shaving cream, deodorant, or lotion, CBD bar of soap from Leef Organics
        with an Organic Garden Handmade Spa Detoxifying Body Scrub, Leef CBD
        Bath Detox, and a Organic Body Detox Breathing Treatment Spray. Also
        includes a $10.00 gift card towards any service.
      </p>
      ...
      <p className="text-center px-5 light-text">
        ...
        size take home shampoo and conditioner. Also includes a $5.00 gift card
        towards any service.
      </p>
